...
parser.add_argument('--exp', default="", type=str, help='model explanation', required=True )  # 훈련 방식 메모
...
if __name__=='__main__':
    print("Train Start")
    main_worker(args)
    print("Finally train is all finish..")
